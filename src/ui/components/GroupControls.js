...
class GroupControls {
  ...
  create() {
    ...
    controls.className = "github-group-controls";
  ...
  createToggleButton() {
    ...
    button.className = "github-control-btn";
  ...
  createManageButton() {
    const button = document.createElement("button");
    button.className = "github-control-btn github-manage-btn";
    button.innerHTML =
      '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"></circle><path d="M12 1v6m0 6v6m4.22-13.22l4.24 4.24M1.54 9.96l4.24 4.24M1 12h6m6 0h6"></path></svg> Manage';
