...
class GroupCard {
  ...
  create() {
    ...
    card.className = "github-group-card";
  ...
  createCardHeader() {
    ...
    cardHeader.className = "github-card-header";
  ...
  createIcon() {
    ...
    icon.className = "github-card-icon";
  ...
  createTitleCount() {
    ...
    titleCount.className = "github-card-title-count";
    ...
    count.className = "github-card-count";
